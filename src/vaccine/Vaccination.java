...
public class Vaccination
{
	...
	//Check availability
	public boolean checkAvailability(List<Vaccine> vaccines,String personName,String vaccineType,String day,String time,int numberOfVaccine,List<String> bookingHistory)
	{
		int flag=0;
